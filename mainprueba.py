#Poner el player que vaya solo. Siguiendo la
import pygame as pg
...
class Game:
    ...
    def render(self):
        ...
        #Hay que calcular con el rec la alineacion en la derecha
        rectmarca1 = self.marcador1.get_rect().right
        #rectmarca1.rightx = get_rect().rightx
        self.screen.blit(rectmarca1, [800, 32])
        #self.screen.blit(self.marcador1, (640, 8))
